-------------------------------------------------------------------------------
--[[  
-- pTable.lua (Prudent Table) - A module for the less-adventurous among us lua-coders
--
...
pT.arrayLengthKey = "uri:http://www.lua.org/ns/arrayLength"
...
-------------------------------------------------------------------------------
--- Internal function - Set the length/size of the array component of table t and registers t as a pTable.
...
--@param t pTable
--@param ... list of pTables which array-element values indicate indices for t - nil arg values are ignored.
...
-- Internal function - For the range of array-index b till e of pTable t, returns an array of element values as a new pTable without type and array bound checks.
-- (nil friendly)
--@param t pTable
--@param b start of range - 1 <= b <= len(t) - defaults to 1.
--@param e end of range - 1 <= e <= len(t) and e >= b - defaults to len(t).
...
-- Internal function - Copies the array elements of pTables t1...tn into the array-component of pTable t starting at index i without any type or bound-checks.
...
-- array-component of a newly created pTable and also sets the key "n" to the size.
-- Registers the "correct" argument list size for the array-length.
-- (nil-friendly)
--@param ... List of elements to add to the array-component of the newly created pTable
--@return New pTable
function pT.pack(...) return 
	local t = pTable(...) 
	t.n = len(t)
	return t
end
