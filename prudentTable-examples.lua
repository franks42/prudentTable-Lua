...
print("aRemove")
pp(t2)
print("aRemove(t2,10)",pt.aRemove(t2,10))
pp(t2)
--print("aRemove(t2,3,5)",pt.aRemove(t2,3,5))
pp(pt.pack(pt.aRemove(t2,3,5)))
pp(t2)
print("aRemove(t2,1,pt.len(t2))",pt.aRemove(t2,1,pt.len(t2)))
pp(t2)
